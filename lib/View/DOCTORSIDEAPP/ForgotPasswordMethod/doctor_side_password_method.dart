import 'package:doctorq/View/DOCTORSIDEAPP/ForgotPasswordMethod/doctorside_forgotpassword_otpscreen.dart';
...
class DoctorForgotPasswordMethodScreen extends StatefulWidget {
  @override
  State<DoctorForgotPasswordMethodScreen> createState() =>
      _DoctorForgotPasswordMethodScreenState();
}

class _DoctorForgotPasswordMethodScreenState
    extends State<DoctorForgotPasswordMethodScreen> {
            ...
            CustomButton(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          DoctorSideForgotPasswordOtpScreen()),
                );
              },
