...
class SetTimmingSettingScreen extends StatelessWidget {
  const SetTimmingSettingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    SetTimeSettingViewModel model =
        Provider.of<SetTimeSettingViewModel>(context);
    return Scaffold(
      body: SafeArea(
          child: Padding(
