...
class PatientHistoryVoiceCallDetailsScreen extends StatefulWidget {
  // DoctorsModel doctor;
  PatientHistoryVoiceCallDetailsScreen();

  @override
  State<PatientHistoryVoiceCallDetailsScreen> createState() =>
      _PatientHistoryVoiceCallDetailsScreenState();
}

class _PatientHistoryVoiceCallDetailsScreenState
    extends State<PatientHistoryVoiceCallDetailsScreen> {
                            ...
                            Align(
                              ...
                              child: ClipRRect(
                                ...
                                child: CommonImageView(
                                  imagePath: ImageConstant.doctor5,
                                  height: getSize(
                                    100.00,
                                  ),
                                  width: getSize(
