...
class LightAppointmentsListWriteReviewFilledScreen extends StatefulWidget {
  ...
  State<LightAppointmentsListWriteReviewFilledScreen> createState() =>
      _LightAppointmentsListWriteReviewFilledScreenState();
}

class _LightAppointmentsListWriteReviewFilledScreenState
    extends State<LightAppointmentsListWriteReviewFilledScreen> {
  String radioGroup = "";
