...
import 'package:doctorq/View/PatientSideApp/light_history_messaging_details_screen/light_history_messaging_details_screen.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class ListrickysebastianItemWidget extends StatelessWidget {
  int index;
  ListrickysebastianItemWidget({required this.index});
