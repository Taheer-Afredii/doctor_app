...
import 'package:doctorq/View/PatientSideApp/light_history_video_call_details_screen/light_history_video_call_details_screen.dart';
...
class Listreply3ItemWidget extends StatelessWidget {
  int index;
  Listreply3ItemWidget({required this.index});
