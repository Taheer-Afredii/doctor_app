...
class LightHistoryVoiceCallDetailsScreen extends StatefulWidget {
  DoctorsModel doctor;
  LightHistoryVoiceCallDetailsScreen({required this.doctor});

  @override
  State<LightHistoryVoiceCallDetailsScreen> createState() =>
      _LightHistoryVoiceCallDetailsScreenState();
}

class _LightHistoryVoiceCallDetailsScreenState
    extends State<LightHistoryVoiceCallDetailsScreen> {
