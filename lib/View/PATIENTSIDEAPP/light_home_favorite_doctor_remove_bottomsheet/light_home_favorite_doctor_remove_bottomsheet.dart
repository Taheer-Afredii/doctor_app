...
class LightHomeFavoriteDoctorRemoveBottomsheet extends StatelessWidget {
  int index;
  List<DoctorsModel> doctorsList;
  LightHomeFavoriteDoctorRemoveBottomsheet(
      {required this.index, required this.doctorsList});
  @override
